...
const seeds = cases.flatMap(([species, evidence, type, reason, property]) => [
    ...
    { prompt: `Explain the charge or electron distribution in ${species}.`, answer: { kind: 'text', value: reason, accepted: [reason] }, solution: reason, concepts: ['electron distribution'] },
