...
const seeds=cases.flatMap(([formula,cat,anion,ratio,nonconduct,conduct])=>[
 {prompt:`What cation-to-anion ratio makes the formula unit ${formula} charge-neutral?`,answer:{kind:'text' as const,value:ratio,accepted:[ratio,ratio.replace(':',' to ')]},solution:`Balancing ${cat} with ${anion} gives ${ratio}.`,representation:'particle' as const},
